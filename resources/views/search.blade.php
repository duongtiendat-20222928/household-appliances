    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            <div class="bg-white p-3 rounded shadow-sm border mb-4">
                <h5 class="fw-bold m-0 border-bottom pb-3 mb-3">
                    <i class="fa-solid fa-magnifying-glass text-meta me-2"></i>
                    Kết quả tìm kiếm cho: <span class="text-danger">"{{ $keyword }}"</span>
                    <span class="text-muted fs-6 fw-normal">({{ $products->count() }} sản phẩm)</span>
                </h5>
                ...
                <div class="row g-3">
                    ...
                    @empty
                        <div class="col-12 text-center py-5">
                            <img src="https://cdn-icons-png.flaticon.com/512/7486/7486747.png" width="100"
                                class="opacity-50 mb-3" alt="Not found">
                            <h5 class="text-muted fw-bold">Rất tiếc, không tìm thấy sản phẩm nào!</h5>
                            <p class="text-muted small">Vui lòng thử lại bằng các từ khóa chung chung hơn (ví dụ: quạt, máy
                                sinh tố, nồi...)</p>
                        </div>
                    @endforelse
                </div>
